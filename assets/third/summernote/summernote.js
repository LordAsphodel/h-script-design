...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      ...
      link: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.link.link + '" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="âŒ˜+K" tabindex="-1"><i class="fa fa-link icon-link"></i></button>';
      },
      video: function (lang) {
      ...
      help: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.options.help + '" data-shortcut="Ctrl+/" data-mac-shortcut="âŒ˜+/" data-event="showHelpDialog" tabindex="-1"><i class="fa fa-question icon-question"></i></button>';
      },
    ...
    var tplShortcutAction = function (lang) {
      return '<table class="note-shortcut">' +
               ...
               '<tbody>' +
                 ...
                 '<tr><td>âŒ˜ + K</td><td>' + lang.link.insert + '</td></tr>' +
