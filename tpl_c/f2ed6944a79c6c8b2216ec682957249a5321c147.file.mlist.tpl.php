<?php /* Smarty version Smarty-3.1.8, created on 2017-09-04 11:45:10
         compiled from "tpl/en/mlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179419164559ad1296beac32-43270503%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2ed6944a79c6c8b2216ec682957249a5321c147' => 
    array (
      0 => 'tpl/en/mlist.tpl',
      1 => 1504512326,
      2 => 'file',
  ...
  'nocache_hash' => '179419164559ad1296beac32-43270503',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ad1296c6b652_29526615',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ad1296c6b652_29526615')) {function content_59ad1296c6b652_29526615($_smarty_tpl) {?><script type="text/javascript" src="js/lists.js"></script><?php if ($_smarty_tpl->tpl_vars['title']->value){?><h2><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
...
<?php }else{ ?>list<?php }?>"><thead><tr><?php if (is_array($_smarty_tpl->tpl_vars['btns']->value)){?><th><input type="checkbox" id="swall" onclick="setchkbox('swall','b')" title="Отметить все"></th><?php }?><?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
"><?php }?>Selected: <?php echo $_smarty_tpl->tpl_vars['include_code']->value;?>
...
<?php }?>"><?php } ?><?php if ($_smarty_tpl->tpl_vars['btn_wrapp']->value){?></div><?php }?></form><?php }?><?php }else{ ?>- No entries -<br><?php }?><br>
<?php }} ?>