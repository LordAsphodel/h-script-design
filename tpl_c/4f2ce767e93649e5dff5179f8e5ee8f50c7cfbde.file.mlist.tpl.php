...
"><?php }?>Отмеченные: <?php echo $_smarty_tpl->tpl_vars['include_code']->value;?>
...
<?php }?>"><?php } ?><?php if ($_smarty_tpl->tpl_vars['btn_wrapp']->value){?></div><?php }?></form><?php }?><?php }else{ ?>- Нет записей -<br><?php }?><br><?php }} ?>