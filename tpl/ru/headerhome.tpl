			...
			<div class="row">
				...
				<div class="col-md-7 col-md-offset-5 col-lg-6 col-lg-offset-6">
					<ul class="stats clearfix">
						<li class="stats__item"><small>Работаем дней</small><span>{$leftstat.worked}</span><i></i></li>
						<li class="stats__item"><small>Всего инвесторов</small><span>{$leftstat.users}</span><i></i></li> 
						<li class="stats__item"><small>Всего инвестировано</small><span>{$leftstat.zin} USD</span></li>
						<li class="stats__item"><small>Доход за всё время</small><span>86.0%</span></li>
					</ul>
				</div>
			</div>
		</div>
