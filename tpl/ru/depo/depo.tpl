{strip}
{include file='headercabinet.tpl' title='Создать депозит'}
		    ...
		    <div class="box-info crypto-box-rate box-rate full animated fadeInDown">
		      ...
		      <form class="rate-cform" method="post" name="new">
			    ...
			    <div class="rate-cont rate-top-15">
			      <div class="cr-title">
			        От <span>{_z($p.pMin, 2)} $</span>          
			      </div>
			      <div class="cr-title">
			        До <span>{_z($p.pMax, 2)} $</span>          
			      </div>
			      ...
			      <div class="row">
			        <div class="col-md-4 col-sm-4 col-xs-4 col-xs-offset-2">
			            ...
			            <div class="sm-gr">в день</div>
			        </div>
			        <div class="col-md-4 col-sm-4 col-xs-4">
			            <div class="sm-bl">
			              Бессрочный
			            </div>
			            <div class="sm-gr">депозит</div>
			        </div>
			      </div>
			      <div class="rate-divider"></div>
			      <br><br>
			    ...
			    <div class="rate-form">
			      <div class="r-form-group">
			        ...
			        <button type="submit" name="new_btn" class="f-element f-button">Инвестировать</button>
			      </div>
			    </div>
			   </form>
		    </div>
