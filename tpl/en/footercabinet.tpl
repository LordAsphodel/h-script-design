...
<footer class="footer text-center">Return to <a href="/">Homepage</a>.<br>Copyrights &copy; 2017 FXStarProfit. All rights reserved</footer>
...
<script src="/assets/js/powerange.min.js"></script>
...
<script type="text/javascript" src="/assets/js/chartist-plugin-pointlabels.js"></script>
...
<script src="/assets/third/wizard/jquery.snippet.js"></script>
