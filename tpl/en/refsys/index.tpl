{strip}
{include file='headercabinet.tpl' title='Referral system'}
...
<h2 class="text-left"><i class="fa fa-history"></i> Your referral link - <a href="{$refurl}">{$refurl}</a></h2>
{if $reflogin}
<h2 class="text-left"><i class="fa fa-history"></i> Your referrer - <a href='javascript:void(0);'><span class='open_popup' rel='popup1'>{$reflogin}</span></a></h2>
{/if}
